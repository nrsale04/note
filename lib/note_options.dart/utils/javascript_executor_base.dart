...
import 'package:mydailynote/note_options.dart/extensions/extensions.dart';
import 'package:mydailynote/note_options.dart/models/callbacks/did_html_change_listener.dart';
import 'package:mydailynote/note_options.dart/models/callbacks/html_changed_listener.dart';
import 'package:mydailynote/note_options.dart/models/callbacks/loaded_listener.dart';
import 'package:mydailynote/note_options.dart/models/enum/command_name.dart';
...
class JavascriptExecutorBase {
  ...
  setTag() async {
    await executeJavascript("setHex();");
  }
  ...
  insertImage(String url, {int? width, int? height, int? rotation}) async {
    if (rotation == null) rotation = 0;
    if (width == null) width = 300;
    if (height == null) height = 300;
    await executeJavascript(
      "insertImage('$url', '$width', '$height', $rotation);",
    );
  }
  ...
  insertCheckbox(String uid) async {
    await executeJavascript("insertCheckbox('$uid');");
  }
